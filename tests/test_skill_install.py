...
class SkillInstallTest(unittest.TestCase):
    ...
    def test_skill_print_includes_required_files(self) -> None:
        ...
        self.assertIn("scripts/patchbay runs --inbox", skill)
        self.assertIn("scripts/patchbay runs --focus", skill)
        ...
        self.assertIn("cancel_background_job", skill)
        self.assertIn("background_control", skill)
        self.assertIn("不要询问我", skill)
        self.assertIn("全部权限给你", skill)
        ...
        self.assertIn("scripts/patchbay runs --inbox", contract)
        self.assertIn("scripts/patchbay runs --focus", contract)
        self.assertIn("scripts/patchbay agent message runs", contract)
        self.assertIn("scripts/patchbay agent message status", contract)
        self.assertIn("scripts/patchbay agent message readiness", contract)
        ...
        self.assertIn("scripts/patchbay status <run_id>", contract)
        self.assertIn("run state, gate state, failure recovery", contract)
        self.assertIn("scripts/patchbay events <run_id>", contract)
        self.assertIn("scripts/patchbay trace <run_id>", contract)
        ...
        self.assertIn("cancel background job", contract)
        self.assertIn("停止后台任务", contract)
        self.assertIn("patchbay_cancel", contract)
        self.assertIn("full access", contract)
        self.assertIn("不要询问我", contract)
        self.assertIn("别找我", contract)
        self.assertIn("别再询问我", contract)
        self.assertIn("所有权限给你", contract)
        self.assertIn("所有权限全都给你", contract)
        self.assertIn("全部权限给你", contract)
        self.assertIn("无需向我确认", contract)
        self.assertIn("自己允许", contract)
        self.assertIn("我根本不在身边", contract)
        ...
        self.assertIn("use Chrome Skill", contract)
        self.assertIn("用你自带的浏览器功能", contract)
        ...
        self.assertIn("initial run-list loading", contract)
        self.assertIn("selected-run detail loading", contract)
        self.assertIn("selected-run polling failures", contract)
        ...
        self.assertIn("use Chrome Skill", install)
        self.assertIn("用你自带的浏览器功能", install)
        self.assertIn("restore both after refresh/reopen", install)
        self.assertIn("selected setup/readiness host", install)
        self.assertIn("stored host", install)
        self.assertIn("patchbay setup without MCP for claude-desktop", install)
        self.assertIn("MCP setup", install)
        self.assertIn("register MCP for Claude Desktop", install)
        ...
        self.assertIn("降本，让简单 writer/fix 走低价模型", install)
