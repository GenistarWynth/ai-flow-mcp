...
- `patchbay_doctor` for read-only setup diagnostics across config, MCP tools, CLI entry points, and Skill installation. Use its `actions[]` for safe setup, Skill, MCP probe, refresh, and economy-profile actions.
