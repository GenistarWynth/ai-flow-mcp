...
- Help responses include `capabilities[]` summaries plus local-only setup and host-specific setup/readiness shortcut actions for Codex, Claude Code, Claude Desktop, and Gemini CLI; render capability summaries as the Agent help surface, and render structured `actions[]` buttons instead of asking users to type setup or doctor prompts.
