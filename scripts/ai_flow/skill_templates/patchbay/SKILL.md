...
- Help responses include host-specific setup and readiness shortcut actions for Codex, Claude Code, Claude Desktop, and Gemini CLI; render those structured `actions[]` buttons instead of asking users to type host-specific setup or doctor prompts.
