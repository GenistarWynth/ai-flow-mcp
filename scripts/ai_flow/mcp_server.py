...
def _tool_schema(name: str) -> dict[str, Any]:
    ...
    descriptions: dict[str, str] = {
        ...
        "patchbay_setup": "Initialize Patchbay project files, create local config, install the Codex Skill, return MCP registration guidance, include a doctor summary, and expose top-level recommendations, recommendation-derived next_actions, and structured actions[] for safe follow-ups. Set skip_mcp=true for local-only setup without MCP registration or follow-up actions.",
        "patchbay_install": "Alias for patchbay_setup: initialize Patchbay project files, create local config, install the Codex Skill, register MCP when possible, include a doctor summary, and expose top-level recommendations, recommendation-derived next_actions, and structured actions[]. Set skip_mcp=true for local-only setup without MCP registration or follow-up actions.",
