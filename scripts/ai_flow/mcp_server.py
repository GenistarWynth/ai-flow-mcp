...
def _tool_schema(name: str) -> dict[str, Any]:
    ...
    descriptions: dict[str, str] = {
        "patchbay_agent": (
            ...
            "setup/readiness shortcuts from help, and help with run_id returns selected-run gate_diagnosis.next_action and next_action "
        ...
        "patchbay_context": "Return the unified handoff digest for resuming a run across MCP hosts, CLI sessions, and the web workbench, including top-level routing_evidence, efficiency_summary, next_actions, action_groups[], and agent_activity.health_cards/conversation_state.suggestions with safe local/diagnostic actions. Active background jobs lift poll_context/status/events into next_actions and background_polling action_groups so clients can refresh progress without advancing gates. Composer-style clients should use action_groups[] to group conversation_state.suggestions into background polling, diagnostics, gate, and new-task sections instead of rendering a flat button list.",
