...
def _tool_schema(name: str) -> dict[str, Any]:
    ...
    descriptions: dict[str, str] = {
        ...
        "patchbay_skill_doctor": "Validate the bundled Patchbay Skill source and whether the installed Skill matches that source in the selected Codex skills root; reports outdated drift through installed_matches_source, missing_installed_files, and changed_installed_files, returning safe install_skill local_agent and refresh_skill_doctor actions plus action_groups[] when follow-up is needed. Host accepts Codex aliases such as Codex Desktop, Codex CLI, and Codex 桌面.",
