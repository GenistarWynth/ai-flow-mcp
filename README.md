...
Mixed Chinese/English cost prompts such as `简单 writer/fix 用 DeepSeek 省钱` are treated as economy-routing intent and apply the write/fix economy profile instead of opening a new task run.
